...
package net.mcreator.timtaransdecorations.entity;
...
import net.mcreator.timtaransdecorations.entity.renderer.ChairRenderer;
import net.mcreator.timtaransdecorations.TimtaransDecorationsModElements;

@TimtaransDecorationsModElements.ModElement.Tag
public class ChairEntity extends TimtaransDecorationsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("chair").setRegistryName("chair");

	public ChairEntity(TimtaransDecorationsModElements instance) {
		super(instance, 3);
